				...
				<div id="page-content">
					...
					<div class="fluid-container">
						...
						<section id="widget-grid" class="">
							...
							<div class="row-fluid">
								<div class="span12">
									<div class="alert alert-error adjusted alert-block">
											<h1 class="alert-heading">Fail</h1>
											<h4>
												You failed to create an experiment...
											</h4>
											<button class="btn btn-small btn-danger" style="margin-top:20px">
												Create An Experiment Again
											</button>
										</div>
								</div>
							</div>
