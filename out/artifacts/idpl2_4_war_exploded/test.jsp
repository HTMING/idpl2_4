									        ...
									        <!-- content goes here -->
												...
												<form  class="form-horizontal themed" id="uislider-demo" action="test?experimentId=${experimentId}"  method="post" novalidate="novalidate">
													<fieldset>
														...
														<div class="control-group">
															<label class="control-label" for="select01">Source</label>
															<div class="controls">
																<select name="dataSource" class="span12" onchange="receiver_change()">
														...
														<div class="control-group">
															<label class="control-label" for="select01">Destination</label>
															<div class="controls">
																<select name="dataDestination" class="span12">
																	<option value="CNIC">CNIC</option>
																	<option value="UCSD">UCSD</option>
																	<option value="WISC">WISC</option>
														        </select>
														...
														<div class="control-group">
															...
															<div class="controls">
																<select name="way" class="span12"  onchange="method_change()">
														...
														<div class="control-group">
															<label class="control-label" for="select01">Data Protocol</label>
															<div class="controls">
														...
														<div class="control-group">
															<label class="control-label" for="select01">IP Protocol</label>
															<div class="controls">
														...
														<div class="control-group">
															<label class="control-label">Number of File(s)</label>
															<div class="controls">
																<p class="info-block">
														...
														<div class="control-group">
															<label class="control-label">Number of Stream(s)</label>
															<div class="controls">
																<p class="info-block">
