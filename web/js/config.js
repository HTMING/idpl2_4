		...
		if ($('#uislider-demo').length) {	
			...
			$( "#slider-range-min" ).slider({
		            ...
		            slide: function( event, ui ) {
		                ...
		                $('#slider-range-min .ui-slider-handle:first').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + ui.value + 'GB</div></div>');
		            }
		        });
		    $("#amount2").val( $( "#slider-range-min" ).slider("value") + "GB");
		    ...
		    $( "#slider-range-min2" ).slider({
	            ...
	            slide: function( event, ui ) {
	                ...
	                $('#slider-range-min2 .ui-slider-handle:first').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + ui.value + '</div></div>');
	            }
	        });
		    $("#amount5").val( $( "#slider-range-min2" ).slider("value"));
		    ...
		    $( "#slider-range-min3" ).slider({
	            ...
	            slide: function( event, ui ) {
	                ...
	                $('#slider-range-min3 .ui-slider-handle:first').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + ui.value + '</div></div>');
	            }
	        });
		    $("#amount6").val( $( "#slider-range-min3" ).slider("value"));
		    ...
		    $( "#slider-range-min4" ).slider({
	            ...
	            slide: function( event, ui ) {
	                ...
	                $('#slider-range-min4 .ui-slider-handle:first').html('<div class="tooltip top slider-tip"><div class="tooltip-arrow"></div><div class="tooltip-inner">' + ui.value + '</div></div>');
	            }
	        });
		    $("#amount7").val( $( "#slider-range-min4" ).slider("value"));
