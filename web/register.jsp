  ...
  <body>
		...
		<header>
			...
			<div id="header-toolbar" class="container-fluid">
				...
				<div class="contained">
					...
					<!-- theme name -->
					<h1> <span class="hidden-phone">NSFC-NSF</span> </h1>
					<!-- end theme name -->
					...
					<div class="pull-right">
						...
						<div id="theme-switcher" class="btn-toolbar">
							...
							<div class="btn-group pull-right visible-phone">
								<a href="javascript:void(0)" class="btn btn-inverse btn-small"><i class="cus-add"></i></a>
							</div>
							<!-- end buttons for phone device -->
							
							<!-- theme dropdown -->
							<!-- <div class="btn-group hidden-phone">
								<a href="./login.html" target="_blank" class="btn btn-inverse btn-small">Login</a>
							</div> -->
							<!-- end theme dropdown-->
			...
			<div class="jarviswidget login">
				<header>
					...
					<div class="widget alert alert-info adjusted">
						...
						<strong>Please set your username and password.</strong>
					</div>
					<!-- content goes here -->
					<div id="main-content">
						
						<form class="form-signin" id="validate-demo-js" method="post" action="register" novalidate="novalidate" >
							<div class="control-group">
								<input type="text" class="input-block-level" autofocus="autofocus" placeholder="Username" name="usernameRegister" id="usernameRegister" value="" />
								<span id="span1"></span> 
							</div>
							<div class="control-group">
								<input type="password" class="input-block-level" placeholder="Password" name="passwordRegister" id="passwordRegister" value="" />
							</div>
							<div class="control-group">
								<input type="password" class="input-block-level" placeholder="Re-enter Password" name="passwordRepeatRegister" id="passwordRepeatRegister" value="" />
							</div>
							<div class="control-group no-border">
								<div style="text-align: right;">
									<input class="btn btn-primary" type="submit" value="Register" id="login-btn"/>
								</div>
							</div>
						</form>
	...
	<script type="text/javascript">
	    ...
	    if(!ismobile){
	        ...
	        $(function() {
	            /* jarvis tooltips */
				$.jGrowl("<strong>press</strong> on <strong>Register</strong> to continue...", { 
					header: 'Hey stranger!', 
					sticky: false,
					life: 5000,
					speed: 500,
    ...
    <!-- script type="text/javascript">    
        ...
        {    
            var username= $.trim($("#usernameRegister").val());      
           $.post("CheckUsernameAction",{usernameRegister:usernameRegister},function(date,state)  
            {  
               if(date.result=="true")  
               {  
                    $("#span1").html("<font color=\"red\">The username has existed!</font>");  
    ...
    <!-- DISABLED  <script src="js/include/jquery.sparkline.min.js"></script> -->
    ...
    <!-- DISABLED  <script src="js/include/bootstrap-datepicker.min.js"></script> -->
