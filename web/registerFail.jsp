		...
		<!-- end header -->	
			...
			<div class="jarviswidget login">
				<header>
					...
					<div class="widget alert alert-warnning adjusted">
						<h1 class="alert-heading">Fail</h1>
									<h4>
										Sorry! You have failed because the name has been registered.
									</h4>
									<a href="./register.html"><button class="btn btn-small btn-success" style="margin-top:20px">
										Return
									</button></a>
					</div>
					<!-- content goes here -->
