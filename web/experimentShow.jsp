            ...
            <div id="page-content">
                ...
                <div class="fluid-container">
                    ...
                    <div id="invoice-bar" class="btn-toolbar">
                        <div class="btn-group">
                            <a href="experiment.jsp">
                                <button type="button" class="btn medium"><i class="cus-add"></i> Add Experiments
                                </button>
                            </a>
                            <a href="showExperiment">
                                <button type="button" class="btn medium"><i class="cus-arrow-refresh"></i> Refresh
                                </button>
                            </a>
                        </div>
                    </div>
                        ...
                        <s:iterator id="experiment" value="experimentList">
                            ...
                            <div class="row-fluid">
                                <article class="span12">
                                    <!-- new widget -->
                                    <div class="jarviswidget jarviswidget-sortable" data-widget-deletebutton="false"
                                         role="widget">
                                        <header>
                                            ...
                                            <div class="inner-spacer">
                                                ...
                                                <table class="table table-bordered table-striped">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!-- <th>Stage</th>  -->
                                                        <!-- <th>Submit</th> -->
                                                        <s:if test="%{#experiment.state=='Completed'}">
                                                            <th>
                                                                <a href="showDetail?experimentId=${experiment.experimentId}&experimentName=${experiment.experimentName}">detail</a>
                                                            </th>
                                                        </s:if>
                                                    </tr>
